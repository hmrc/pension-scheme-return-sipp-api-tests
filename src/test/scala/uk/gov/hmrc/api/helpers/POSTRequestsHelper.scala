...
import uk.gov.hmrc.api.service.PensionSchemeReturnSippPOSTRequestService

class POSTRequestsHelper {

  val pensionSchemeReturnPOSTServiceAPI: PensionSchemeReturnSippPOSTRequestService =
    new PensionSchemeReturnSippPOSTRequestService
