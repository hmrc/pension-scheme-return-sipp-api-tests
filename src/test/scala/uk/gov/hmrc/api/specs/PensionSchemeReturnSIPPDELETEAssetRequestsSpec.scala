...
class PensionSchemeReturnSIPPDELETEAssetRequestsSpec extends BaseSpec with HttpClient {
  ...
  Feature("Update Request for member details for assets class") {
    ...
    Scenario("Verify 200 response when Delete request to Update record") {
      ...
      DELETERequestsHelper.pensionSchemeReturnDELETEServiceAPI.deleteAsset(authBearerToken, payload, "delete-assets")
    }
    ...
    Scenario("401 Unauthorized error when DELETE request to Update details without token") {
      ...
      DELETERequestsHelper.pensionSchemeReturnDELETEServiceAPI.deleteAsset("", payload, "delete-assets")
    }
    ...
    Scenario("400 Server error when DELETE request to Update without payload") {
      ...
      DELETERequestsHelper.pensionSchemeReturnDELETEServiceAPI.deleteAsset(authBearerToken, "", "delete-assets")
    }
  }
}
